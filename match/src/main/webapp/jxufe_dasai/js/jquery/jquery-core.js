...
(function (a2, aB) {
    ...
    bG.extend({
        ...
        }, globalReturnEval: function (e) {
            return function (bZ) {
                return a2["eval"].call(a2, bZ)
            }(e)
    ...
    bG.event = {
        add: function (b1, b5, cc, b3, b2) {
            ...
            b1 = null
        }, global: {}, remove: function (b1, b6, cc, b2, b5) {
    ...
    (function (cS, ch) {
        ...
        cL = cQ.selectors = {
            ...
            attrHandle: cC ? {} : {
                ...
                }, first: cF(function (e, c8, c7) {
                    return [0]
                }),
                last: cF(function (e, c8, c7) {
                    return [c8 - 1]
                }),
                eq: cF(function (e, c8, c7) {
                    return [c7 < 0 ? c7 + c8 : c7]
                }),
                even: cF(function (e, c9, c8) {
                    for (var c7 = 0; c7 < c9; c7 += 2) {
                        e.push(c7)
                    }
                    return e
                }),
                odd: cF(function (e, c9, c8) {
                    for (var c7 = 1; c7 < c9; c7 += 2) {
                        e.push(c7)
                    }
                    return e
                }),
        ...
        function b1(da, df) {
            ...
            while (dc) {
                ...
                for (de in cL.filter) {
                    if ((db = cG[de].exec(dc)) && (!e[de] || (db = e[de](db, b8, true)))) {
                        dd.push(c7 = new b4(db.shift()));
                        dc = dc.slice(c7.length);
                        c7.type = de;
                        c7.matches = db
        ...
        function c2(c8, c7, da, c9, db, e) {
            ...
            return c1(function (dn, dk, de, dm) {
                if (dn && db) {
                    return
                }
                var dl, dg, dh, df = [],
                    dp = [],
                    dd = dk.length,
                    dc = dn || cp(c7 || "*", de.nodeType ? [de] : de, [], dn),
                    di = c8 && (dn || !c7) ? cv(dc, df, c8, de, dm) : dc,
                    dj = da ? db || (dn ? c8 : dd || c9) ? [] : dk : di;
                if (da) {
                    da(di, dj, de, dm)
                }
                if (c9) {
                ...
                if (dn) {
                    ...
                    while (dl--) {
                        if ((dg = dj[dl])) {
                            dn[df[dl]] = !(dk[df[dl]] = dg)
                        }
                    }
                } else {
                    dj = cv(dj === dk ? dj.splice(dd, dj.length) : dj);
                    if (db) {
                        db(null, dk, dj, dm)
                    } else {
                        cW.apply(dk, dj)
            ...
            (function () {
                ...
                if (c9) {
                    ...
                    cQ.matchesSelector = function (de, dg) {
                        dg = dg.replace(c8, "='$1']");
                        if (!cm(de) && !e.test(dg) && (!c7 || !c7.test(dg))) {
                            try {
        ...
        ajax: function (b4, b1) {
            ...
            function ca(cs, co, ct, cq) {
                ...
                if (e) {
                    ...
                    bG.ajaxSettings.errorCall = bG.ajaxSettings.errorCall || [];
                    bG.each(bG.ajaxSettings.errorCall, function (cx, cy) {
            ...
            if (b8.crossDomain == null) {
                cd = aT.exec(b8.url.toLowerCase()) || false;
            ...
            if (typeof $("#_TOKEN").attr("value") === "string") {
                b8.url += (bN.test(b8.url) ? "&" : "?") + "_TOKEN=" + $("#_TOKEN").attr("value")
            }
