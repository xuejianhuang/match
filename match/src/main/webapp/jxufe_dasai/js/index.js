...
// if (window.location.host != 'www.mq11837910.icoc.me') { window.location.href
// = 'http://' + 'www.mq11837910.icoc.me'; }
...
$(function() {
			...
			.ajax({
				...
				success : function(result) {
					...
					if (member != null) {
							...
							$("#memberBarArea")
									.append(
											" <div id='arrow' class='g_arrow g_arrow_up'></div> "
													...
													+ "</a> "
													+ "<a href='mCenter.html'><span class='userLabel' title='等级：普通会员' id='memberName'>"
													+ member.name
													+ "</span></a> "
						...
						if ($(".J_memberLoginPanel")) {
							$(".J_memberLoginPanel").hide();
						}
						if ($("#memberLoginPanel")) {
							$("#memberLoginPanel").append(
									"<div class='memberWelcome'> "
											+ member.name + "，欢迎登录。</div>");
						}
					} else {
						if ($("#memberBarArea"))
							$("#memberBarArea").hide();
	...
	$('#pagenation624').find('a').hover(function() {
		$(this).addClass('g_hover')
	}, function() {
		$(this).removeClass('g_hover')
	});
	Site.loadNewsList(624, {
		"y" : 0,
		"s" : 0,
		"w" : 1
	}, false);
	Site.loadNewsNewStyle(624, false, false, false, true, false, false, false,
			false, false);
	Site.initMixNews({
		moduleId : 624,
		leader : '0'
	...
	Site.loadNewsList(625, {
		"y" : 0,
		"s" : 0,
		"w" : 1
	}, true);
	Site.loadNewsNewStyle(625, false, false, false, true, false, false, false,
			false, false);

	Site.loadNewsList(629, {
		"y" : 0,
		"s" : 0,
		"w" : 1
	}, false);
	Site.loadNewsNewStyle(629, false, false, false, true, false, false, false,
			false, false);
	Site.initMixNews({
		moduleId : 629,
		leader : '0'
	...
	Site.initModuleMemberLogin(653, 2, true, false, {
		"skipUrl" : "index.jsp",
		"isPhotoGroup" : false
	});

	Site.initContentSplitLine(657, {
		"y" : 0,
		"s" : 0,
		"w" : 1
	});
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg2puHwwUo3rO41wEw8gI4ugI.png",
							"isInit" : false
						},
						"tagetOption" : {
	...
	Site.loadNewsList(649, {
		"y" : 2,
		"s" : 2,
		"c" : "#dbdbdb",
		"w" : 1
	}, true);
	Site.loadNewsNewStyle(649, false, false, true, true, false, false, false,
			false, false);

	Site.initMulColModuleInIE('#module650');
	/*
	 * Fai.top.Photo603 = {}; Fai.top.Photo603.ieOpt =
	 * {"effType":1,"borderType":false,"borderColor":"#000","borderWidth":1,"borderStyle":1,"style":90,"fullMaskCusBg":false,"fullMaskCusDisc":false,"halfMaskCusBg":false,"halfMaskCusDisc":false,"fullMaskOpenDisc":false};
	 * Fai.top.Photo603.tgOpt =
	 * {"nameHidden":false,"nameWordWrap":false,"targetParent":"photoMarqueeForm","target":"imgDiv","picScale":2};
	 * Fai.top.Photo603.callbackArgs = []; Site.loadPhotoMarquee(603, 2, true,
	 * 0, 'listPhotos'); Fai.top.photoSlideTmp603 = {}; Fai.top.photoSlideTmp603 =
	 * {"photoSlideId":"photoSlide_603","photoSlideType":0,"photoDataList":[{"id":0,"name":"","basic":"","pic":"ABUIABAEGAAgyaPdwgUon8jDhAYwmgU4vAM","picPath":"http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAgyaPdwgUon8jDhAYwmgU4vAM.png","picWidth":666,"picHeight":444},{"id":1,"name":"","basic":"","pic":"ABUIABAEGAAggKTdwgUo4-ruDTCaBTi8Aw","picPath":"http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAggKTdwgUo4-ruDTCaBTi8Aw.png","picWidth":666,"picHeight":444},{"id":2,"name":"","basic":"","pic":"ABUIABAEGAAgiaTdwgUowubMODCaBTi8Aw","picPath":"http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAgiaTdwgUowubMODCaBTi8Aw.png","picWidth":666,"picHeight":444},{"id":3,"name":"","basic":"","pic":"ABUIABACGAAgnKTdwgUozOHr1gQwtAE4dw","picPath":"http://12329909.s21i-12.faiusr.com/2/ABUIABACGAAgnKTdwgUozOHr1gQwtAE4dw.jpg","picWidth":180,"picHeight":119},{"id":4,"name":"","basic":"","pic":"ABUIABACGAAgpKTdwgUoiOimugYwtAE4hwE","picPath":"http://12329909.s21i-12.faiusr.com/2/ABUIABACGAAgpKTdwgUoiOimugYwtAE4hwE.jpg","picWidth":180,"picHeight":135}],"pluginsOptions":{"closeBtn":{"on":true,"arg":{}},"prevBtn":{"on":true,"arg":{}},"nextBtn":{"on":true,"arg":{}},"descPanel":{"on":true,"arg":{}}}};
	 * Fai.top.changeMarquee603 =
	 * function(){Fai.stopInterval('marquee603');Site.loadPhotoMarquee(603, 2,
	 * true, 0, 'listPhotos');}; Fai.top.listPhotos603 = {id:603,style:90,
	 * data:{"cusPicSize":true,"picScale":2,"newMarqueeToward":0}}
	 */
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg_8uCwwUoosnekQUw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAgs8yCwwUolsPTzwMw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg0syCwwUo9MDHqgMw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg6syCwwUoiJ2TkAQw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg4s2CwwUovMPbBDDQATg3.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAg782CwwUo946cygMw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAgg86CwwUo8tqC2QQw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
			...
			.run(
					...
					},
					{
						...
						"imgEffOption" : {
							...
							"hovFont" : "faisco-icons-contact2",
							"hovFontColor" : "#222222",
							"picPath" : "http://12329909.s21i-12.faiusr.com/4/ABUIABAEGAAgks6CwwUo9Jn8xgQw0AE4Nw.png",
							"isInit" : false
						},
						"tagetOption" : {
							"targetParent" : "floatImg_J",
...
var nav102SubMenu = [ {
	"hidden" : false,
	"colId" : 101,
	"href" : "nr.html?type=0&page=1",
	"target" : " target='_self'",
	"colName" : "赛事新闻",
	"html" : "<span class='itemName0'>赛事新闻<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 102,
	"href" : "nr.html?type=2&page=1",
	"target" : " target='_self'",
	"colName" : "赛事通知",
	"html" : "<span class='itemName0'>赛事通知<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 103,
	"href" : "nr.html?type=1&page=1",
	"target" : " target='_self'",
	"colName" : "往届赛事",
	"html" : "<span class='itemName0'>往届赛事<\/span>",
	"title" : ""
} ];
var nav112SubMenu = [ {
	"hidden" : false,
	...
	"target" : " target='_self'",
	"colName" : "培训指南",
	"html" : "<span class='itemName0'>培训指南<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 202,
	...
	"target" : " target='_self'",
	"colName" : "培训平台",
	"html" : "<span class='itemName0'>培训平台<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 203,
	...
	"target" : " target='_self'",
	"colName" : "下载专区",
	"html" : "<span class='itemName0'>下载专区<\/span>",
	"title" : ""
} ];
var nav107SubMenu = [ {
	"hidden" : false,
	"colId" : 110,
	"href" : "/matchPlatform/public/login.html",
	"target" : " target='_self'",
	"colName" : "大赛报名",
	"html" : "<span class='itemName0'>大赛报名<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 110,
	...
	"target" : " target='_self'",
	"colName" : "培训报名",
	"html" : "<span class='itemName0'>培训报名<\/span>",
	"title" : ""
}, {
	"hidden" : false,
	"colId" : 111,
	...
	"target" : " target='_self'",
	"colName" : "成绩查询",
	"html" : "<span class='itemName0'>成绩查询<\/span>",
	"title" : ""
} ];
var nav6SubMenu = [];
...
var _templateBackgroundData = {
	"id" : "AD0I7vb9BBACGAAgwaKfvgUoj9LRMDCADzjoBw",
	"bBg" : {
		"y" : 1,
		"c" : "#000",
		"f" : "",
	...
	"clw" : -1,
	"crw" : -1,
	"p" : "http://10451822.s61i.faiusr.com/2/AD0I7vb9BBACGAAgwaKfvgUoj9LRMDCADzjoBw.jpg",
	"bm" : {},
	"cm" : {},
	"cp" : {
		"y" : 0
